...
{
	private readonly SummitClientOptions _options;
	...
	public CustomNewtonsoftJsonContentSerializer(SummitClientOptions options, ILogger logger)
	{
		_options = options;
		_logger = logger;
	...
	public async Task<T?> FromHttpContentAsync<T>(HttpContent content, CancellationToken cancellationToken = default) => _options.JsonMissingMemberHandling switch
	{
